...
class MaterialPriceChartVC: UIViewController, ChartDelegate {
    ...
    private func loadViewData() {
        self.date.text = "\(self.convertDateFormat(fromFormat: "yyyyMMdd", toFormat: "yyyy-MM-dd", date: self.priceData.last![0] as! String)) 가격"
        switch (self.param?.tableName)! {
        case MaterialType.wtiCrudeOil.table(),
             MaterialType.naturalGas.table():
            self.button1.setTitle("Open", for: .normal)
            self.label1.text = self.priceData.last![1] as? String
            self.button2.setTitle("High", for: .normal)
            self.label2.text = self.priceData.last![2] as? String
            self.button3.setTitle("Low", for: .normal)
            self.label3.text = self.priceData.last![3] as? String
            self.button4.setTitle("Last", for: .normal)
            self.label4.text = self.priceData.last![4] as? String
            self.button5.setTitle("Change", for: .normal)
            self.label5.text = self.priceData.last![5] as? String
            self.button6.setTitle("Settle", for: .normal)
            self.label6.text = self.priceData.last![6] as? String
            self.button7.setTitle("Volume", for: .normal)
            self.label7.text = self.priceData.last![7] as? String
            self.button8.setTitle("Previous Day Open Interest", for: .normal)
            self.button8.titleLabel?.font = UIFont.systemFont(ofSize: 8)
            self.label8.text = self.priceData.last![8] as? String
        ...
        case MaterialType.brentCrudeOil.table():
            ...
            self.label9.text = self.priceData.last![9] as? String
            self.button10.setTitle("EFS Volume", for: .normal)
            self.label10.text = self.priceData.last![10] as? String
            self.button11.setTitle("Block Volume", for: .normal)
            self.label11.text = self.priceData.last![11] as? String
            self.button12.isHidden = true
            self.label12.isHidden = true
        case MaterialType.opecCrudeOil.table(),
             MaterialType.iron.table():
        ...
        case MaterialType.aluminum.table(),
            ...
            self.label12.text = self.priceData.last![12] as? String
