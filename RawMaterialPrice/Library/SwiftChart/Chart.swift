...
open class Chart: UIControl {
    ...
    */
    @IBInspectable
    open var labelColor: UIColor = UIColor.lightGray

    /**
    Color for the axes.
    */
    @IBInspectable
    open var axesColor: UIColor = UIColor.gray.withAlphaComponent(0.8)
    ...
    */
    open var highlightLineColor = UIColor.lightGray

    /**
    Width for the highlight line.
    */
    open var highlightLineWidth: CGFloat = 0.7
    ...
    */
    open var areaAlphaComponent: CGFloat = 0.15
